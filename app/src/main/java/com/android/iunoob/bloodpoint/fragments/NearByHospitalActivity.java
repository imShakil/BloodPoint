...
import com.android.iunoob.bloodpoint.viewmodels.GetNearbyPlacesData;
...
public class NearByHospitalActivity extends Fragment implements
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        else Toast.makeText(getActivity(), "MapFragment is null, why?", Toast.LENGTH_LONG).show();
    ...
    private String getUrl(double latitude, double longitude) {
        ...
        googlePlaceUrl.append("&type=").append("hospital");
